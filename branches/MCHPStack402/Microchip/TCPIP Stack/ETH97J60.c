...
void MACInit(void)
{
	...
	//Ivan.
	// If we have an early revision silicon(exactly how early?), RXAPDIS should 
	// NOT be set, contrary to the datasheet. This could probably be
	// made a run-time check but it's unknown which versions work
	#if !defined(ETH_18Fx7J60_ERRATA)
