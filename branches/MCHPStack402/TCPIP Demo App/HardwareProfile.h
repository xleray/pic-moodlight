...
//#define	OLIMEX_WEB		// based on PIC18F452 - will it run?
//#define	OLIMEX_MINI		// based on PIC18F25J10
//#define	OLIMEX_MICRO		// based on PIC18F67J60
//#define OLIMEX_P67J60
//#define YOUR_BOARD
...
#if !defined(PICDEMNET2) && !defined(HPC_EXPLORER) && !defined(PICDEMZ) && !defined(FS_USB) && !defined(PICDEMNET) && !defined(EXPLORER_16) && !defined(DSPICDEM11) && !defined(DSPICDEMNET1) && !defined(DSPICDEMNET2) && !defined(PICDEMNET2) && !defined(PIC18F67J60_TEST_BOARD) && !defined(OLIMEX_MAXI) && !defined(OLIMEX_WEB) && !defined(OLIMEX_MINI) && !defined(OLIMEX_MICRO) && !defined(OLIMEX_P67J60) && !defined(YOUR_BOARD)
...
// This value is used to calculate Tick Counter value
	...
	// All PIC18 processors
			...
			defined(OLIMEX_MAXI) || defined(OLIMEX_MICRO) || defined(OLIMEX_P67J60)
...
//		#define CLOCK_FREQ		(40000000)      // Hz
	...
	#elif defined(OLIMEX_WEB) || defined(OLIMEX_MINI)
...
#elif defined(OLIMEX_MAXI) && defined(HI_TECH_C)
	#error "Hi-Tech compilers not yet supported"
	
#elif defined(OLIMEX_WEB) && defined(HI_TECH_C)
	#error "Hi-Tech compilers not yet supported"
	
#elif defined(OLIMEX_MINI) && defined(HI_TECH_C)
	#error "Hi-Tech compilers not yet supported"
...
// PIC18F97J60 based, atmel dataflash, 2 buttons, 3 LED's+2 relays, UART, LCD
	...
	#define BUTTON2_TRIS		(TRISCbits.TRISC2)	// AKA IN1
	#define	BUTTON2_IO			(PORTCbits.RC2)
	#define BUTTON3_TRIS		(TRISGbits.TRISG4)	// AKA IN2
	#define	BUTTON3_IO			(PORTGbits.RG4)
	#define BUTTON4_TRIS		(TRISBbits.TRISB4)	// AKA IN3
	#define	BUTTON4_IO			(PORTBbits.RB4)
	#define BUTTON5_TRIS		(TRISAbits.TRISA4)	// AKA IN4
	#define	BUTTON5_IO			(PORTAbits.RA4)
...
#elif defined(OLIMEX_WEB) && !defined(HI_TECH_C)
// pic18f452+enc28j60, atmel dataflash, 1 button, 1 LED, UART
	#define LED0_TRIS			(TRISDbits.TRISD5)
	#define LED0_IO				(PORTDbits.RD5)	
	#define LED_IO				(*((volatile unsigned char*)(&PORTD)))
...
#elif defined(OLIMEX_MINI) && !defined(HI_TECH_C)
// pic18f25J10+enc28j60, atmel dataflash, 1 button, 1 LED
	#define LED0_TRIS			(TRISCbits.TRISC2)
	#define LED0_IO				(PORTCbits.RC2)
...
#elif defined(OLIMEX_MICRO) && !defined(HI_TECH_C)
// PIC18F67J60 based, atmel dataflash, 1 LED
...
// PIC18F67J60 based, atmel dataflash, 1 LED, 1 button
...
#if ((defined(__18F97J60)) && !defined(PICDEMNET2) &&!defined(OLIMEX_MAXI) && !defined(YOUR_BOARD)) || \
	((defined(__18F67J60)) && !defined(PIC18F67J60_TEST_BOARD) && !defined(OLIMEX_MICRO) && !defined(OLIMEX_P67J60) && !defined(YOUR_BOARD)) || \
	((defined(__18F18F8722) || defined(__18F87J10) || defined(__18F45J10)) && !defined(HPC_EXPLORER) && !defined(YOUR_BOARD)) || \
	((defined(__18F452)) && !defined(OLIMEX_WEB)) || \
	((defined(__PIC24F__) || defined(__PIC24H__) || defined(__dsPIC33F__)) && !defined(EXPLORER_16) && !defined(YOUR_BOARD)) || \
	((defined(__dsPIC30F__)) && !defined(DSPICDEM11) && !defined(DSPICDEMNET1) && !defined(DSPICDEMNET2) && !defined(YOUR_BOARD))
