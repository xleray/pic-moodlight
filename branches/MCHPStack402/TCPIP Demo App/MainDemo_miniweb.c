...
// Set configuration fuses
		...
		#pragma config XINST=OFF, WDTEN=OFF, FOSC=HSPLL
    ...
    case CGI_CMD_DIGOUT:	// ACTION=0
       ...
       /* case CMD_LED2:	// NAME=1
        ...
        state_ext = TestExt();	
				...
				switch(state_ext) {
					case  TEST_OK: memcpypgm2ram(ERRORString, (ROM void*)TestOk, sizeof(TestOk)); break;
					case  TEST_GND: memcpypgm2ram(ERRORString, (ROM void*)ErrGnd, sizeof(ErrGnd)); break;
					case  TEST_VCC: memcpypgm2ram(ERRORString, (ROM void*)ErrVcc, sizeof(ErrVcc)); break;
					case  TEST_ZERO_A: memcpypgm2ram(ERRORString, (ROM void*)ErrPA, sizeof(ErrPA)); break;
					case  TEST_ZERO_B: memcpypgm2ram(ERRORString, (ROM void*)ErrPB, sizeof(ErrPB)); break;
					case  TEST_ZERO_C: memcpypgm2ram(ERRORString, (ROM void*)ErrPC, sizeof(ErrPC)); break;
					default: memcpypgm2ram(ERRORString, (ROM void*)UnknownErr, sizeof(UnknownErr));
				}
				InitializeBoard();
    		MPFSInit();
    		/*InitAppConfig();
