...
// Ivan - here we enable only the most basic services - only the absolutely
// necesarry ones. This allows to use a single TCPICnfig.h for all projects and
// fit even on the smaller devices (e.g. PIC18F25J10 with 32Kbytes ROM and 
// 1Kbyte RAM. We enable additinal services if there is enough space based on
// the board type later on.
...
#define STACK_USE_HTTP_TWITTER_POST
	...
	#define MY_DEFAULT_HOST_NAME			"OLIMEX MAXI"
	#define MY_DEFAULT_MAC_BYTE6            (0x05)
	#define MY_DEFAULT_IP_ADDR_BYTE4        (95ul)
...
#if defined(OLIMEX_WEB)
	#define STACK_USE_UART
	//#define STACK_USE_FTP_SERVER
	//#define STACK_USE_DHCP_CLIENT
	//#define STACK_USE_DHCP_SERVER
	//#define STACK_USE_ICMP_SERVER
	#define MY_DEFAULT_HOST_NAME			"OLIMEX WEB"
	#define MY_DEFAULT_MAC_BYTE6            (0x07)
	#define MY_DEFAULT_IP_ADDR_BYTE4        (8ul)
...
#if defined(OLIMEX_MINI)
	#define STACK_USE_FTP_SERVER
	#define MY_DEFAULT_HOST_NAME			"OLIMEX MINI"
	#define MY_DEFAULT_MAC_BYTE6            (0x09)
	#define MY_DEFAULT_IP_ADDR_BYTE4        (97ul)
	
	#define MAX_TCP_SOCKETS     (4ul)
	#define TCP_TX_FIFO_SIZE	(200ul)
	#define TCP_RX_FIFO_SIZE	(200ul)
	#define MAX_UDP_SOCKETS     (6ul)
	#define MAX_HTTP_CONNECTIONS	(2ul)
#endif
	...
	#define STACK_USE_DNS
	#define STACK_USE_FTP_SERVER
	#define MY_DEFAULT_HOST_NAME			"OLIMEX MICRO"
	#define MY_DEFAULT_MAC_BYTE6            (0x0a)
	#define MY_DEFAULT_IP_ADDR_BYTE4        (98ul)
	...
	#define STACK_USE_DNS
	#define STACK_USE_FTP_SERVER
	#define MY_DEFAULT_HOST_NAME			"OLIMEX P67J60"
	#define MY_DEFAULT_MAC_BYTE6            (0x0b)
...
// Ivan - we use different adress for each type of board to allow testing
...
// for each socket)
// Ivan - per-project specific options now
/*#define MAX_TCP_SOCKETS     (8ul)
#define TCP_TX_FIFO_SIZE	(200ul)
#define TCP_RX_FIFO_SIZE	(200ul)
