...
volatile unsigned char mask_port_a 	= 0x3F; 
volatile unsigned char mask_port_b 	= 0x03;
volatile unsigned char mask_port_c 	= 0xC4;
volatile unsigned char mask_port_d 	= 0x07;
volatile unsigned char mask_port_e 	= 0x1F;
volatile unsigned char mask_port_f 	= 0x04;
...
unsigned char TestExt(void) 
{
	...
	if( ((temp_porta) != (0xFF)) ||  
		...
		((temp_porte) != (0xFF)) ||  
		((temp_portf) != (0xFF)) ||  
		((temp_portg) != (0xFF)) )  return TEST_GND;
	...
	if( ((temp_porta) != (0x0)) ||
		...
		((temp_porte) != (0x0)) ||
		((temp_portf) != (0x0)) ||
		((temp_portg) != (0x0)) ) return TEST_VCC;
